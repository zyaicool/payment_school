...
func TestSetupBillingHistoryRoutes(t *testing.T) {
	// Inisialisasi Fiber app
	app := fiber.New()
	api := app.Group("/api/v1") 
	
	billingHistoryController := &controllers.BillingHistoryController{}

	// Setup routes
	SetupBillingHistoryRoutes(api, billingHistoryController)
	...
	expectedRoutes := []struct {
		...
		{"GET", "/api/v1/billingHistory/getAllBillingHistory"},
		{"GET", "/api/v1/billingHistory/detailBillingHistory"},
		{"GET", "/api/v1/billingHistory/printInvoice"},
	}
